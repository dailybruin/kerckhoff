...
class PackageVersionTestCase(TestCase):
    ...
    def test_PackageVersion_creation(self):
        ...
        packageA.create_version("David", "This version uses Hong Yi")
        ...
        self.assertEqual(myPV.creator, "David")     
        ...
        packageA.create_version("Carey", "This version uses HONG YEET") # Now we should have 2 different versions of packageA
        ...
        self.assertEqual(myPV.creator, "Carey")     
